...
class _OnboardingWidgetState extends State<OnboardingWidget> {
  ...
  void initState() {
    ...
    _model.socialsTextFieldTextController ??= TextEditingController();
    _model.socialsTextFieldFocusNode ??= FocusNode();
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            width: 250.0,
                            child: TextFormField(
                              controller: _model.socialsTextFieldTextController,
                              focusNode: _model.socialsTextFieldFocusNode,
                              autofocus: false,
                              enabled: true,
                              obscureText: false,
                              decoration: InputDecoration(
